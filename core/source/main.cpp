...
int main(int argc, char const *argv[])
{
  ...
  object->addComponent(new OrbitalCamera(-5, Vec3<bool>(false, false, true), Vec3<float>(-15, -180, 0), &object->getComponent<RotateTransform>()->rotation, &object->getComponent<Transform>()->getPos(), true, object));
